...
drvno db 80h ; 磁盘驱动器号：0=软盘A、1=软盘B、80h=硬盘C
i dw 0 ; 循环变量
n dw 0 ; 命令串长度
...
; 磁盘驱动器复位
	...
	mov	dl, 80h	; dl=80h（软驱为0，硬盘和U盘为80h）
	int	13h		; 磁盘中断
